class Info extends Phaser.Scene { //creates a scene in the Phaser Object called Info, to be referenced in game.js
  ...
  create() {
    ...
    this.textTitle.setTint(0xffb43c); //set current title colour
    ...
    this.textInfo.setTint(0x70fff2); //set current info colour
    ...
    this.textStory.setTint(0xf6f7ff); //set readable story colour
    ...
    if (!touch) { //if touch variable false
      ...
      this.textControls.setTint(0x70fff2); //set current controls colour
      ...
      this.textTouchControls.setTint(0x70fff2); //set current controls colour
    ...
    this.textExit.setTint(0xffb43c); //set current exit text colour
    ...
    this.btnBack.clearTint(); //use supplied button art
    ...
    this.btnBack.on("pointerover", function() { //this Back Button when on method, in hover
      ...
      this.btnBack.setAlpha(0.82) // hover feedback without recolouring art
    }, this); //this state only

    this.btnBack.on("pointerout", function() { //this Back Button when on method, in hover
      this.btnBack.setAlpha(1); // restore supplied art
    }, this); //this state only

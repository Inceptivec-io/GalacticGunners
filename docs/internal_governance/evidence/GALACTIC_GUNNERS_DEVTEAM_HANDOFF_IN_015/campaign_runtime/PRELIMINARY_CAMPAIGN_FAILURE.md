...
`npm run runtime:campaign` reached the Level 1 completion and Level 2 runtime surfaces, then timed out waiting for Level 2 Continue to load Level 3. The retained screenshots document the state reached before failure; they are not passing evidence.

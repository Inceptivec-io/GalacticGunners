...
- Added favicon link versioning so browser tab caches refresh to the current crest.
...
- Browser/CDP verification PASS at 1366x665 constrained desktop viewport; result includes explicit bounds for key menu elements: `FOUNDER_REVIEW_MENU_FONT_FAVICON_CHECK.json`.

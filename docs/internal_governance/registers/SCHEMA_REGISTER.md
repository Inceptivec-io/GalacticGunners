...
| HTTP API | `packages/contracts/openapi/galactic-gunners-api-v1.yaml` | explicit API versioning | GROUNDWORK |
| JSON payload contracts | `packages/contracts/schemas/` | contract versioning | GROUNDWORK |

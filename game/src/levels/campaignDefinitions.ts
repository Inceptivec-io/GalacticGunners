...
export const CAMPAIGN_DEFINITIONS: LevelDefinition[] = [
  ...
  level({ id: 'level-02', slug: 'level-02', name: 'Asteroid Advance', sequence: 2, seed: 12002,
    enemy_formations: [{ type: 'scout', rows: 3, columns: 16, origin: { x: 70, y: 120 }, spacing: { x: 66, y: 48 } }, { type: 'cruiser', rows: 1, columns: 8, origin: { x: 190, y: 255 }, spacing: { x: 128, y: 0 } }],
    hazards: [{ type: 'asteroid', count: 3, speed: 72, origin: { x: 180, y: 240 }, spacing: { x: 290, y: 64 } }, { type: 'comet', count: 1, speed: 112, origin: { x: 860, y: 210 }, spacing: { x: 0, y: 0 } }],
  ...
  level({ id: 'level-03', slug: 'level-03', name: 'Cruiser Crossfire', sequence: 3, seed: 12003,
    enemy_formations: [{ type: 'scout', rows: 2, columns: 16, origin: { x: 72, y: 110 }, spacing: { x: 64, y: 52 } }, { type: 'cruiser', rows: 2, columns: 6, origin: { x: 170, y: 220 }, spacing: { x: 168, y: 52 } }, { type: 'destroyer', rows: 1, columns: 4, origin: { x: 220, y: 325 }, spacing: { x: 248, y: 0 } }],
  ...
  level({ id: 'level-04', slug: 'level-04', name: 'Frigate Breach', sequence: 4, seed: 12004,
    enemy_formations: [{ type: 'scout', rows: 2, columns: 15, origin: { x: 72, y: 110 }, spacing: { x: 68, y: 50 }, behaviour_profile: 'enemy.scout.diver' }, { type: 'cruiser', rows: 1, columns: 6, origin: { x: 170, y: 220 }, spacing: { x: 170, y: 0 } }, { type: 'destroyer', rows: 1, columns: 4, origin: { x: 240, y: 300 }, spacing: { x: 240, y: 0 } }],
    ...
    boarding_anchors: [{ id: 'level-04-alien-frigate-01', source_selector: { formation_index: 1, row: 0, column: 5 }, source_entity_type: 'cruiser', source_ship_type: 'ALIEN_FRIGATE', source_entity_id: 'level-04:formation-1:r0:c5', interior: { slug: 'alien-frigate', version: 1, checksum: 'e9b1af65f0daef6725a7ddf4683b5f6d503e25dabc97aef1212102e6b1e994f3' }, entry_envelope: { width_px: 160, height_px: 128 }, offer_duration_ms: 8000 }],
  }),
  level({ id: 'level-05', slug: 'level-05', name: 'Elite Gauntlet', sequence: 5, seed: 12005,
    enemy_formations: [{ type: 'scout', rows: 2, columns: 12, origin: { x: 72, y: 105 }, spacing: { x: 84, y: 48 } }, { type: 'cruiser', rows: 2, columns: 6, origin: { x: 160, y: 205 }, spacing: { x: 176, y: 58 } }, { type: 'destroyer', rows: 2, columns: 4, origin: { x: 210, y: 325 }, spacing: { x: 255, y: 55 } }],

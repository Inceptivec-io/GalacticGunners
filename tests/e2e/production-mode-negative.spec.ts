...
test('H015-PROD-001__e2e_ordinary_user_negative__qa_query_cannot_enable_diagnostic_globals', async ({ page, strictRuntime }) => {
  ...
  expect(diagnostics).toEqual({ hostile: false, slice: false, menu: false, pause: false, boarding: false });

...
test("GG-PRODUCT-ENTRY-001__e2e_ordinary_user__fresh_play_shows_splash_before_menu", async ({
  page,
  strictRuntime,
}) => {
  await page.goto("/");
...
test("GG-PRODUCT-ENTRY-001__e2e_ordinary_user_negative__internal_navigation_does_not_replay_splash", async ({
  page,
  strictRuntime,
}) => {

...
test("GG-ASSURANCE-EVIDENCE-001 positive: the delivered replacement sources and receipt reconcile", () => {
  assert.deepEqual(validateAssuranceRecoveryIntake({ root: replacementAdmissionRoot }), []);
});

test("GG-ASSURANCE-EVIDENCE-001 negative: a changed required transport hash fails closed", () => {

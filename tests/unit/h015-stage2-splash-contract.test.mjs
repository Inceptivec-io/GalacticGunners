...
test("H015-ENTRY-002 verifier asserts the approved four-second splash contract", async () => {
  const verifier = await readFile("scripts/verify-h015-stage2-navigation.mjs", "utf8");
